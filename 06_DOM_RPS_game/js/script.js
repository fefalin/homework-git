...
window.onload = event => {
    ...
    rock.onclick = event => {
        ...
        //     computerChoice.getElementsByTagName('img')[0].src = './images/paper.png';
        // } else if (computerChoiceValue === 'Scissors') {
        //     computerChoice.getElementsByTagName('img')[0].src = './images/scissors.png';
        // } else if (computerChoiceValue === 'Rock') {
        //     computerChoice.getElementsByTagName('img')[0].src = './images/rock.png';
        // }
        computerChoice.getElementsByTagName('img')[0].src = './images/'+ computerChoiceValue.toLowerCase() +'.png';
